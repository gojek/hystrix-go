...
func TestTimeout(t *testing.T) {
	t.Parallel()
	test.SyncTest(t, func(t *testing.T) {
		const circuitName = "hystrix-timeout"
		ctx := t.Context()
...
func TestTimeoutEmptyFallback(t *testing.T) {
	t.Parallel()
	test.SyncTest(t, func(t *testing.T) {
		const circuitName = "test-timeout-empty-fallback"
		ctx := t.Context()
		ConfigureCommand(circuitName, CommandConfig{Timeout: 100})
...
func TestMaxConcurrent(t *testing.T) {
	t.Parallel()
	test.SyncTest(t, func(t *testing.T) {
		const circuitName = "hystrix-max-concurrent"
...
func TestCloseCircuitAfterSuccess(t *testing.T) {
	t.Parallel()
	test.SyncTest(t, func(t *testing.T) {
		const circuitName = "hystrix-close-circuit-after-success"
...
func TestFailAfterTimeout(t *testing.T) {
	t.Parallel()
	test.SyncTest(t, func(t *testing.T) {
		const circuitName = "hystrix-fail-after-timeout"
...
func TestSlowFallbackOpenCircuit(t *testing.T) {
	t.Parallel()
	test.SyncTest(t, func(t *testing.T) {
		const circuitName = "hystrix-slow-fallback-open-circuit"
		ConfigureCommand(circuitName, CommandConfig{Timeout: 10})
...
func TestFallbackAfterRejected(t *testing.T) {
	t.Parallel()
	test.SyncTest(t, func(t *testing.T) {
		const circuitName = "hystrix-fallback-after-rejected"
...
func TestReturnTicket_QuickCheck(t *testing.T) {
	t.Parallel()
	test.SyncTest(t, func(t *testing.T) {
		const circuitName = "hystrix-return-ticket-quick-check"
...
func TestReturnTicket(t *testing.T) {
	t.Parallel()
	test.SyncTest(t, func(t *testing.T) {
		const circuitName = "hystrix-return-ticket"
		ctx := t.Context()
		ConfigureCommand(circuitName, CommandConfig{Timeout: 10})
...
func TestContextHandling(t *testing.T) {
	t.Parallel()
	test.SyncTest(t, func(t *testing.T) {
		const circuitName = "hystrix-context-handling"
...
func TestDoC_Timesout(t *testing.T) {
	t.Parallel()
	test.SyncTest(t, func(t *testing.T) {
		const circuitName = "hystrix-doc-timesout"
		ConfigureCommand(circuitName, CommandConfig{Timeout: 10})
