...
[![Build Status](https://travis-ci.org/gojek/hystrix-go.png?branch=master)](https://travis-ci.org/gojek/hystrix-go)
[![GoDoc Documentation](http://godoc.org/github.com/gojek/hystrix-go/hystrix?status.png)](https://godoc.org/github.com/gojek/hystrix-go/hystrix)
...
For API documentation, refer to [GoDoc](https://godoc.org/github.com/gojek/hystrix-go/hystrix)

How to use
----------

```go
import "github.com/gojek/hystrix-go/hystrix"
```
...
- ```cd /go/src/github.com/gojek/hystrix-go```
- ```go test ./...```
