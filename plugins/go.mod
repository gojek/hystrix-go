...
require (
	...
	github.com/gojek/hystrix-go/plugins/datadog v0.0.0-00010101000000-000000000000
	github.com/gojek/hystrix-go/plugins/graphite v0.0.0-00010101000000-000000000000
